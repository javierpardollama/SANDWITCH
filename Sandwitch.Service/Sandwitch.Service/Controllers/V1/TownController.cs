...
/// <summary>
///     Represents a <see cref="TownController" /> class. Inherits <see cref="ControllerBase" />
/// </summary>
...
public class TownController(IMediator mediator) : ControllerBase
{
    ...
    /// <returns>Instance of <see cref="Task{OkObjectResult}" /> whose result is a <see cref="ViewTown"/>.</returns>
    [MapToApiVersion(1.0)]
    [HttpPut]
    [Route("update")]
    ...
    public async Task<IActionResult> UpdateTown([FromBody] UpdateTown viewModel)
    {
        return Ok(await mediator.Send(new UpdateTownCommand { ViewModel = viewModel }));
    }
    ...
    [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
    [ProducesResponseType(StatusCodes.Status503ServiceUnavailable, Type = typeof(ProblemDetails))]
    public async Task<IActionResult> FindAllTown()
    {
        return Ok(await mediator.Send(new FindAllTownQuery()));
    }
    ...
    /// <returns>Instance of <see cref="Task{OkObjectResult}" /> whose result is a <see cref="ViewPage{ViewTown}"/>.</returns>
    [MapToApiVersion(1.0)]
    [HttpPost]
    [Route("page")]
    ...
    [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
    [ProducesResponseType(StatusCodes.Status503ServiceUnavailable, Type = typeof(ProblemDetails))]
    public async Task<IActionResult> FindPaginatedTown([FromBody] FilterPage viewModel)
    {
        return Ok(await mediator.Send(new FindPaginatedTownQuery { ViewModel = viewModel }));
    }
    ...
    [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
    [ProducesResponseType(StatusCodes.Status503ServiceUnavailable, Type = typeof(ProblemDetails))]
    public async Task<IActionResult> AddTown([FromBody] AddTown viewModel)
    {
        return Ok(await mediator.Send(new AddTownCommand { ViewModel = viewModel }));
    }
    ...
    [ProducesResponseType(StatusCodes.Status500InternalServerError, Type = typeof(ProblemDetails))]
    [ProducesResponseType(StatusCodes.Status503ServiceUnavailable, Type = typeof(ProblemDetails))]
    public async Task<IActionResult> RemoveTownById(int id)
    {
