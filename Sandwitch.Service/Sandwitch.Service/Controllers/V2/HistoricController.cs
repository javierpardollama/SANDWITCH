...
/// <summary>
///     Represents a <see cref="HistoricController" /> class. Inherits <see cref="ControllerBase" />
/// </summary>
...
public class HistoricController(IMediator mediator) : ControllerBase
{
    ...
    [HttpPost]
    [Route("create")]
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ViewHistoric))]
    ...
    public async Task<IActionResult> AddHistoric([FromBody] AddHistoric viewModel)
    {
        return Ok(await mediator.Send(new AddHistoricCommand { ViewModel = viewModel }));
    }
}