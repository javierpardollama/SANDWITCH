...
[TestFixture]
public class BeachesTest : BaseTest
{
    [Test]
    public void Add()
    {
        ...
        Wait.Until(d => d.FindElement(By.Id("beach-add-modal")).Displayed);
    ...
    public void Edit()
    {
        ...
        Wait.Until(d => d.FindElement(By.Id("beach-update-modal")).Displayed);
