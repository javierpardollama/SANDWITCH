...
[TestFixture]
public class StatesTest : BaseTest
{
    [Test]
    public void Add()
    {
        ...
        Wait.Until(d => d.FindElement(By.Id("state-add-modal")).Displayed);
    ...
    public void Edit()
    {
        ...
        Wait.Until(d => d.FindElement(By.Id("state-update-modal")).Displayed);
